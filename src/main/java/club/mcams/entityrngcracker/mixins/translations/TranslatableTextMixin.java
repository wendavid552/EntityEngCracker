...
import club.mcams.entityrngcracker.translations.TranslationConstants;
...
public abstract class TranslatableTextMixin
{
    ...
    {
//        System.out.println("1$$$TranslatableTextMixin: " + vanillaTranslatedFormattingString);
        if (this.key.startsWith(TranslationConstants.TRANSLATION_KEY_PREFIX) && vanillaTranslatedFormattingString.equals(this.key))
        {
//            System.out.println("TranslatableTextMixin: " + this.key);
            String tiscmTranslated = CarpetExtensionTranslations.getTranslationString(CarpetExtensionTranslations.getServerLanguage(), this.key);
