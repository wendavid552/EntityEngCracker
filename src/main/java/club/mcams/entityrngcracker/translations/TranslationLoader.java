...
import static club.mcams.entityrngcracker.translations.TranslationConstants.TRANSLATION_NAMESPACE;
...
public class TranslationLoader
{
	...
	public static void loadTranslations(Map<String, Map<String, String>> translationStorage)
	{
		...
		{
			CrackerServer.LOGGER.error("Failed to read language list", e);
			return;
		}
	...
	private static Map<String, String> loadTranslationFile(String lang)
	{
		...
		catch (Exception e)
		{
			...
			CrackerServer.LOGGER.error(message, e);
