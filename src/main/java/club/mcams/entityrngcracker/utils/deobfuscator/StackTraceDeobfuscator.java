...
package club.mcams.entityrngcracker.utils.deobfuscator;

import club.mcams.entityrngcracker.CrackerServer;
import club.mcams.entityrngcracker.translations.Translator;
import club.mcams.entityrngcracker.CrackerMod;
import club.mcams.entityrngcracker.utils.AutoMixinAuditUtils;
import club.mcams.entityrngcracker.utils.deobfuscator.mapping.MappingReader;
import club.mcams.entityrngcracker.utils.deobfuscator.mapping.TinyMappingV2Reader;
import club.mcams.entityrngcracker.utils.deobfuscator.yarn.OnlineMappingProvider;
...
public class StackTraceDeobfuscator
{
	...
	{
		if (AutoMixinAuditUtils.isEnabled())
		{
			CrackerServer.LOGGER.info("Disabled online mapping fetching since mixin audit executor is armed");
			return;
		}
		if (!fetchedMapping)
		{
	...
	public static boolean loadMappings(InputStream inputStream, String mappingVersion)
	{
		...
		{
			CrackerServer.LOGGER.error("Fail to load mapping {}", mappingVersion, e);
			return false;
		}
