...
import club.mcams.entityrngcracker.CrackerSettings;
import club.mcams.entityrngcracker.mixins.translations.StyleAccessor;
import club.mcams.entityrngcracker.mixins.translations.TranslatableTextAccessor;
...
//#if MC >= 11600
//$$ import club.mcams.entityrngcracker.mixins.utils.DyeColorAccessor;
//$$ import net.minecraft.text.TextColor;
//#endif

//#if MC < 11500
//$$ import club.mcams.entityrngcracker.mixins.carpet.access.MessengerInvoker;
//#endif
...
public class Messenger
{
	...
	{
		if (CrackerServer.minecraftServer != null)
		{
			//#if MC >= 11900
			//$$ CrackerServer.minecraftServer.sendMessage(text);
			//#elseif MC >= 11600
			//$$ CrackerServer.minecraftServer.sendSystemMessage(text, Util.NIL_UUID);
			//#else
			CrackerServer.minecraftServer.sendMessage(text);
			//#endif
		}
	...
	public static void broadcast(BaseText text)
	{
		...
		if (CrackerServer.minecraftServer != null)
		{
			CrackerServer.minecraftServer.getPlayerManager().getPlayerList().forEach(player -> tell(player, text));
		}
	}
